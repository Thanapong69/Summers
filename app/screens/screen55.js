...
import {sum} from './screen5'

let year = 0
let total = 0
class Screen55 extends Component {
  callFun1 = () =>
  {
    year = 4
    total = (1800000 - sum)/48 + (((1800000 - sum)/48)*2.5)/100
  ...
  {
    year = 5
    total = (1800000 - sum)/60 + (((1800000 - sum)/60)*3.0)/100
    this.props.navigation.navigate('show_yaris')
  }
  ...
  {
    year = 6
    total = (1800000 - sum)/72 + (((1800000 - sum)/72)*3.5)/100
    this.props.navigation.navigate('show_yaris')
  }
  ...
  {
    year = 7
    total = (1800000 - sum)/84 + (((1800000 - sum)/84)*4.0)/100
    this.props.navigation.navigate('show_yaris')
  }
